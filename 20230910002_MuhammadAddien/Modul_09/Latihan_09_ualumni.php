    ...
    if ($check !== false) {
      ...
      if ($uploadOk == 0) { 
        ...
        if (move_uploaded_file($_FILES["foto"]["tmp_name"], $target_file)) { 
          //lika file berhasil diunggah, tambahkan data ke database
          $sql = "UPDATE alumni SET nama='$nama', tahun_lulus='$tahun_Julus', jurusan='$jurusan', foto='$target_file' WHERE id=$id";
  ...
  ?>
    ...
    <div class="container mt-5">
      ...
      <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          <label for="tahun Julus" class="form-label">Tahun Lulus</label>
